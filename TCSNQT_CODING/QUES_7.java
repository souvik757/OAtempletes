...
/**
   ...
   Alice is acting as a mediator, and the rest of the N friends are seated on N chairs, one each.
   ...
   However, if the digits do not match, Alice will ask each friend’s digits, and she will offer the T-shirts
   to only those who understood the digits correctly.

   Given N number of friends and digit array D, denoting the digit understood by each friend F.
   finds out how many of Alice’s friends have not enacted well OR did not understand the
...
public class QUES_7 {
    public static void main(String[] args){
        ...
        solution_Ques_7 obj = new solution_Ques_7() ;
        int N = sc.nextInt() ;
        int[] arr = new int[N] ;
        for (int i = 0 ; i< N ; i ++)
            arr[i] = sc.nextInt() ;
